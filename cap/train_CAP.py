...
'''Local Imports'''
# Assuming these are custom modules you've implemented or modified
...
batch_size = 8
checkpoint_freq = 5
dataset_dir = "101_food_classes_10_percent"
epochs = 100
image_size = (224,224)
lstm_units = 128
...
full_img = layers.Lambda(lambda x: tf.image.resize(x, size=(ROIS_resolution, ROIS_resolution)), name='Lambda_img_1')(x_final)
