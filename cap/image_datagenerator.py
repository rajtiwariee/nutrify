...
# Note: 'apply_affine_transform' function is not directly available in tf.keras. You might need to
# use 'tf.keras.preprocessing.image.apply_affine_transform' if it's available in your TensorFlow version,
# or implement the affine transformation using TensorFlow or another library.
